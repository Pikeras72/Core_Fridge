                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InputTexto(Colors.white, 0, 25, 20, 5, "Enter Name", Colors.white, 280, 25, Colors.white, false),
                        const SizedBox(height: 30),
                        InputTexto(Colors.white, 0, 25, 20, 5, "Enter Email", Colors.white, 280, 25, Colors.white, false),
                        const SizedBox(height: 30),
                        InputTexto(Colors.white, 0, 25, 20, 5, "Enter Password", Colors.white, 280, 25, Colors.white, true),
                        const SizedBox(height: 30),
                        InputTexto(Colors.white, 0, 25, 20, 5, "Confirm Password", Colors.white, 280, 25, Colors.white, true),
