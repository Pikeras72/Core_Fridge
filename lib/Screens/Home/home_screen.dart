          ...
          children: [
            Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      Tarjeta(Image.asset('assets/images/agua.jpg'), Colors.black, 35, 35, 6, "Agua Mineral","500ml", 0.75, Producto(Image.asset('assets/images/aguaProducto.png'),"Agua Mineral","Contiene minerales y otras sustancias disueltas como gases, sales o compuestos sulfurados")),
                      Tarjeta(Image.asset('assets/images/aquarius.jpg'), Colors.black, 35, 35, 6, "Aquarius","330ml", 1, Producto(Image.asset('assets/images/aquariusProducto.png'), "Aquarius","Bebida complementaria para deportistas, especialmente dirigida para las personas que disfrutan de un estilo de vida activo")),
                      Tarjeta(Image.asset('assets/images/cocacola.jpg'), Colors.black, 35, 35, 6, "CocaCola","330ml", 1, Producto(Image.asset('assets/images/cocaColaProducto.png'), "CocaCola","Bebida azucarada gaseosa vendida a nivel mundial en tiendas, restaurantes y máquinas expendedoras")),
                      Tarjeta(Image.asset('assets/images/donetes.jpg'), Colors.black, 35, 35, 6, "Donettes","150g", 1, Producto(Image.asset('assets/images/donetesProducto.png'), "Donettes","Pequeñas rosquillas dulces bañadas en chocolate blanco y chocolate negro. Tienen  un sabor dulce gracias a la textura del chocolate")),
                      Tarjeta(Image.asset('assets/images/fanta.jpg'), Colors.black, 35, 35, 6, "Fanta","330ml", 1, Producto(Image.asset('assets/images/fantaProducto.png'), "Fanta", "Bebida refrescante de zumo de frutas con azúcares, gran variedad de bebidas para satisfacer las necesidades de un amplio abanico de consumidores")),
                      ...
                      Tarjeta(Image.asset('assets/images/sandwich.jpg'), Colors.black, 35, 35, 6, "Sandwich","150g", 1.2, Producto(Image.asset('assets/images/sandwichProducto.png'), "Sandwich","El alimento perfecto: portátil y tan simple o elaborado como lo prefiera el consumidor. ")),
                      SizedBox(height: 10,),
                    ],
                  ),
                ),
